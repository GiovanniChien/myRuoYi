...
import cn.chien.domain.entity.SysDictData;
import cn.chien.domain.entity.SysDictType;
import cn.chien.exception.ServiceException;
import cn.chien.mapper.SysDictDataMapper;
import cn.chien.mapper.SysDictTypeMapper;
import cn.chien.service.ISysDictTypeService;
import cn.chien.util.DictUtils;
    ...
    public void loadingDictCache() {
        ...
        for (Map.Entry<String, List<SysDictData>> entry : dictDataMap.entrySet()) {
            DictUtils.setDictCache(entry.getKey(),
                    entry.getValue().stream().sorted(Comparator.comparing(SysDictData::getDictSort))
