...
public class DictUtils {
    ...
    public static void setDictCache(String key, List<SysDictData> dictDatas) {
        CacheClient.put(getCacheName(), getCacheKey(key), dictDatas);
    }
    ...
    public static List<SysDictData> getDictCache(String key) {
        Object cacheObj = CacheClient.get(getCacheName(), getCacheKey(key), Object.class);
    ...
    public static void removeDictCache(String key) {
        CacheClient.evict(getCacheName(), getCacheKey(key));
    }
    ...
    public static void clearDictCache() {
        CacheClient.evictAllEntries(getCacheName());
    }
