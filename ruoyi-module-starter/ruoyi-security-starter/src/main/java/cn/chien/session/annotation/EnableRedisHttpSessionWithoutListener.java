...
package cn.chien.session.annotation;

import cn.chien.session.config.RedisHttpSessionConfigurationWithoutListener;
...
@Documented
@Import(RedisHttpSessionConfigurationWithoutListener.class)
@Configuration(proxyBeanMethods = false)
public @interface EnableRedisHttpSessionWithoutListener {
	 ...
	 * @since 2.0.0
	 */
	String cleanupCron() default RedisHttpSessionConfigurationWithoutListener.DEFAULT_CLEANUP_CRON;
