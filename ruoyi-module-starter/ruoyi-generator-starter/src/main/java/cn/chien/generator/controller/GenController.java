package cn.chien.generator.controller;
...
import cn.chien.domain.CxSelect;
...
import cn.chien.generator.service.IGenTableColumnService;
...
public class GenController extends BaseController {
    ...
    @PostMapping("/list")
    @ResponseBody
    public TableDataInfo genList(@RequestBody GenTablePageRequest genTable) {
    ...
    @PostMapping("/db/list")
    @ResponseBody
    public TableDataInfo dataList(@RequestBody GenTablePageRequest genTable) {
        PageHelper.startPage(genTable.getPageNum(), genTable.getPageSize());
        List<GenTable> list = genTableService.selectDbTableList(genTable);
        return getDataTable(list);
    }
    
    private TableDataInfo getDataTable(List<GenTable> list) {
     ...
     */
    @RequiresPermissions("tool:gen:list")
    @BusinessLog(title = "代码生成", businessType = BusinessType.IMPORT)
    ...
    public AjaxResult importTableSave(String tables) {
        ...
        String operName = Convert.toStr(AuthThreadLocal.getLoginName());
     ...
     */
    @RequiresPermissions("tool:gen:edit")
    @BusinessLog(title = "代码生成", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @BusinessLog(title = "代码生成", businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    ...
    @RequiresRoles("admin")
    @BusinessLog(title = "创建表", businessType = BusinessType.OTHER)
    @PostMapping("/createTable")
    @ResponseBody
    public AjaxResult create(@RequestBody Map<String, Object> map) {
    ...
    @BusinessLog(title = "代码生成", businessType = BusinessType.GENCODE)
