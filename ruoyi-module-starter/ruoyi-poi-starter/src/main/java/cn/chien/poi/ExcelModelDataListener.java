        ...
        while (i < excelFields.size()) {
            ...
            if (CollectionUtils.isEmpty(excelField.getSubField())) {
                ...
                if (adapter instanceof DefaultExcelFieldHandler defaultAdapter) {
                    defaultAdapter.setExcel2JavaConvert(this.converters);
                }
                ...
                Object fieldVal = adapter.excel2JavaFormat(obj, excelField.getField().getType(), excelField.getExcelAnnotation());
