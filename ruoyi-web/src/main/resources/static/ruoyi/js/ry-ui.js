        ...
        table: {
            ...
            exportExcel: function (formId) {
                ...
                $.modal.confirm("确定导出所有" + table.options.modalName + "吗？", function () {
                    ...
                    var dataParam = $.form.val("#" + currentId);
                    $.extend(dataParam, {'orderByColumn': params.sortName, 'isAsc': params.sortOrder});
                    $.modal.loading("正在导出数据，请稍候...");
                    // 文件地址
                    const url = table.options.exportUrl;
                    ...
                    xhr.onload = function () {
                        ...
                        if (this.readyState === 4 && this.status === 200) {
                            // 返回200
                            blob = this.response;
                            let filename = decodeURI(xhr.getResponseHeader("ajax-filename"));
